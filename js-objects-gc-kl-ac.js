...
//   return `The product is the ${product.name}. It costs $${product.price}`;
// };
...
// const pbRecipe = (lunch) => {
//   return `The ingredients for PB and Banana sandwich are ${lunch.ingredients[0]}, ${lunch.ingredients[1]}, and ${lunch.ingredients[2]}.`;
// };
